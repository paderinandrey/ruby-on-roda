...
Container.register_provider(:rack_attack) do
  prepare do
    require 'rack/attack'
  end

  start do
    target_container.start(:redis)

    # Configure Redis cache.
    Rack::Attack.cache.store = Rack::Attack::StoreProxy::RedisStoreProxy.new(target['persistance.redis'])
